  ...
  return (
    <section id="navigation" className="space-y-8">
      ...
      <div className="space-y-4">
        <h3 className="text-lg font-medium text-slate-300">Simple Navbar</h3>
      ...
      {/* Navbar with Search */}
      <div className="space-y-4">
        <h3 className="text-lg font-medium text-slate-300">Navbar with Search</h3>
        <nav className="flex items-center justify-between px-6 py-4 bg-slate-800/50 border border-white/10 rounded-xl">
      ...
      {/* Tabs */}
      <div className="space-y-4">
        <h3 className="text-lg font-medium text-slate-300">Tabs</h3>
      ...
      {/* Underline Tabs */}
      <div className="space-y-4">
        <h3 className="text-lg font-medium text-slate-300">Underline Tabs</h3>
      ...
      {/* Breadcrumbs */}
      <div className="space-y-4">
        <h3 className="text-lg font-medium text-slate-300">Breadcrumbs</h3>
      ...
      {/* Pagination */}
      <div className="space-y-4">
        <h3 className="text-lg font-medium text-slate-300">Pagination</h3>
      ...
      {/* Sidebar Menu */}
      <div className="space-y-4">
        <h3 className="text-lg font-medium text-slate-300">Sidebar Menu</h3>
