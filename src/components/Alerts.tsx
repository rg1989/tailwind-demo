...
export function Alerts() {
  return (
    <section id="alerts" className="space-y-8">
      ...
      <CodeBlock
        title="Success Alert"
        code={`<div className="flex items-center gap-4 p-4 bg-emerald-500/10 border border-emerald-500/30 rounded-lg">
  ...
  <button className="text-emerald-400 hover:text-emerald-300 transition-colors">
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <CodeBlock
        title="Error Alert"
        code={`<div className="flex items-center gap-4 p-4 bg-rose-500/10 border border-rose-500/30 rounded-lg">
  ...
  <button className="text-rose-400 hover:text-rose-300 transition-colors">
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <CodeBlock
        title="Warning Alert"
        code={`<div className="flex items-center gap-4 p-4 bg-amber-500/10 border border-amber-500/30 rounded-lg">
  ...
  <button className="text-amber-400 hover:text-amber-300 transition-colors">
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <CodeBlock
        title="Info Alert"
        code={`<div className="flex items-center gap-4 p-4 bg-sky-500/10 border border-sky-500/30 rounded-lg">
  ...
  <button className="text-sky-400 hover:text-sky-300 transition-colors">
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <CodeBlock
        title="Simple Left-Border Alert"
        code={`<div className="p-4 bg-slate-800 border-l-4 border-indigo-500 rounded-r-lg">
  ...
  <p className="text-slate-400 text-sm">This is a simpler alert style with a left border accent.</p>
      ...
      <CodeBlock
        ...
        code={`<div className="bg-slate-800 border border-white/10 rounded-xl p-4 shadow-xl flex items-start gap-3 max-w-sm">
    ...
    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      >
        <div className="flex justify-end">
          <div className="bg-slate-800 border border-white/10 rounded-xl p-4 shadow-xl flex items-start gap-3 max-w-sm">
            <div className="w-8 h-8 bg-emerald-500/20 rounded-full flex items-center justify-center shrink-0">
              <svg className="w-4 h-4 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
