  ...
  return (
    <section id="badges" className="space-y-8">
      ...
      <div className="space-y-4">
        <h3 className="text-lg font-medium text-slate-300">Status Badges</h3>
      ...
      {/* Solid Badges */}
      <div className="space-y-4">
        <h3 className="text-lg font-medium text-slate-300">Solid Badges</h3>
        <div className="flex flex-wrap gap-3">
      ...
      {/* Outline Badges */}
      <div className="space-y-4">
        <h3 className="text-lg font-medium text-slate-300">Outline Badges</h3>
        <div className="flex flex-wrap gap-3">
      ...
      {/* Badge with Dot */}
      <div className="space-y-4">
        <h3 className="text-lg font-medium text-slate-300">Badge with Dot</h3>
        <div className="flex flex-wrap gap-3">
      ...
      {/* Tags */}
      <div className="space-y-4">
        <h3 className="text-lg font-medium text-slate-300">Tags (Removable)</h3>
      ...
      {/* Number Badges */}
      <div className="space-y-4">
        <h3 className="text-lg font-medium text-slate-300">Number Badges</h3>
