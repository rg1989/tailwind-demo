  ...
  <div className="space-y-2">
    ...
    <div className="h-3 bg-slate-700 rounded animate-pulse w-5/6"></div>
      ...
      <CodeBlock
        ...
        code={`<button disabled className="inline-flex items-center gap-2 px-6 py-2.5 bg-indigo-600 text-white font-medium rounded-lg opacity-75 cursor-not-allowed">
