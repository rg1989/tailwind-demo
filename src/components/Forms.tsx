...
export function Forms() {
  ...
  <div className="w-full px-4 py-8 border-2 border-dashed border-white/20 rounded-lg text-center hover:border-indigo-500/50 transition-colors cursor-pointer">
    ...
    <p className="text-slate-400 text-sm">Drop files here or click to upload</p>
      ...
      <CodeBlock
        title="Checkboxes"
        code={`<label className="flex items-center gap-3 cursor-pointer group">
...
<label className="flex items-center gap-3 cursor-pointer group">
  ...
  <span className="text-slate-300 group-hover:text-white transition-colors">Pro Plan</span>
      ...
      >
        <div className="space-y-4">
          <label className="flex items-center gap-3 cursor-pointer group">
            <input type="radio" name="plan-demo" className="w-5 h-5 border-white/20 bg-slate-800 text-indigo-600 focus:ring-indigo-500 focus:ring-offset-0 cursor-pointer" />
            <span className="text-slate-300 group-hover:text-white transition-colors">Basic Plan</span>
          </label>
          <label className="flex items-center gap-3 cursor-pointer group">
            <input type="radio" name="plan-demo" defaultChecked className="w-5 h-5 border-white/20 bg-slate-800 text-indigo-600 focus:ring-indigo-500 focus:ring-offset-0 cursor-pointer" />
            <span className="text-slate-300 group-hover:text-white transition-colors">Pro Plan</span>
          </label>
          <label className="flex items-center gap-3 cursor-pointer group">
            <input type="radio" name="plan-demo" className="w-5 h-5 border-white/20 bg-slate-800 text-indigo-600 focus:ring-indigo-500 focus:ring-offset-0 cursor-pointer" />
