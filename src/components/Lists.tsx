    ...
    <section id="lists" className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          <h3 className="text-lg font-medium text-slate-300">Simple List</h3>
          <ul className="bg-slate-800/50 border border-white/10 rounded-xl divide-y divide-white/5">
        ...
        {/* List with Icons */}
        <div className="space-y-4">
          <h3 className="text-lg font-medium text-slate-300">List with Icons</h3>
          <ul className="bg-slate-800/50 border border-white/10 rounded-xl divide-y divide-white/5">
        ...
        {/* Todo List */}
        <div className="space-y-4">
          <h3 className="text-lg font-medium text-slate-300">Todo List</h3>
        ...
        {/* Activity Feed */}
        <div className="space-y-4">
          <h3 className="text-lg font-medium text-slate-300">Activity Feed</h3>
          <div className="space-y-4">
